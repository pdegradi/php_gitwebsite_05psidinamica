...
<h2>Erik Erikson</h2>
<p>Erik Erikson (1902-1994), come molti autori psicoanalitici, non voleva inizialmente mettere in discussione la teoria di Freud. Le
...
<p>Senza negare la teoria psicobiologica di Freud, Erikson aggiunge una <strong>dimensione psicosociale</strong>: le pulsioni,
all'origine prive di forma, prendono forma solo all'interno di una cultura e di una storia specifica. Per esempio, culture diverse
incoraggiano tempi diversi per togliere il ciuccio o il pannolino, in base all'idea che hanno di quando il bambino raggiunga un
funzionamento più maturo. Le angosce del bambino vengono quindi interpretate e assumono significato in base alla cultura in cui
nasce.</p>



<h3>Confronto con la psicologia dell'Io</h3>
<p>Come gli psicologi dell'Io, Erikson sostiene che parti dell'Io agiscano indipendentemente dalla motivazione pulsionale e servano
...
<p>Il passaggio da una fase all'altra è determinato da una <strong>crisi psicosociale</strong>: un periodo cruciale che porta a un
...
<p>Erikson individua otto fasi, ciascuna caratterizzata da un conflitto tra due tendenze opposte e dall'acquisizione di una specifica
capacità dell'Io:</p>
<ol>
<li><strong>Fiducia di base vs sfiducia di base</strong> (primo anno di vita, parallela alla fase orale): l'Io acquisisce la capacità
di avere speranza.</li>
<li><strong>Autonomia vs vergogna e dubbio</strong> (2-3 anni, parallela alla fase anale): l'Io acquisisce la volontà.</li>
<li><strong>Senso di iniziativa vs senso di colpa</strong> (4-5 anni, parallela alla fase fallica): l'Io acquisisce la capacità di
determinazione.</li>
...
<li><strong>Intimità vs isolamento</strong> (prima età adulta, circa 20-24 anni): la risoluzione di questo conflitto porta alla
capacità di amare.</li>
<li><strong>Generatività vs stagnazione</strong> (seconda età adulta, circa 25-66 anni): fase in cui si apprende la capacità di
prendersi cura degli altri (la generatività non riguarda solo il desiderio di avere figli, ma anche una creatività più ampia).</li>
<li><strong>Integrità dell'Io vs senso di disperazione</strong> (dai 65 anni alla morte): il superamento efficace di questa fase porta
alla saggezza.</li>
</ol>
<p>Il punto centrale della teoria di Erikson è che questi temi di vita sono in conflitto in ogni momento dell'esistenza: lo sviluppo
dell'Io non finisce mai, e ogni crisi esistenziale superata porta a un Io sempre più forte e capace di affrontare nuove situazioni.
Il mancato superamento di una fase, al contrario, comporta un regresso e un maggior rischio di psicopatologia e di un funzionamento
psichico meno maturo.</p>



<h3>Fiducia vs sfiducia: il primo anno di vita</h3>
<p>Nel primo anno di vita il conflitto esistenziale fondamentale è acquisire un senso di fiducia. La prima grande conquista evolutiva
è la capacità di tollerare l'allontanamento della madre senza ansia, perché si ha fiducia che tornerà (per esempio nella fase in
cui il bambino impara a dormire da solo nel proprio lettino).</p>
<p>Secondo Erikson, comportamenti materni amorevoli e coerenti permettono di acquisire questa fiducia di base e di generalizzarla a
tutte le relazioni future. Tali comportamenti sono però influenzati dalla cultura e dalla concezione sociale della maternità:
alcune famiglie ritengono educativo lasciare piangere il bambino per abituarlo all'autonomia, altre intervengono subito, altre
ancora fanno dormire tutti insieme. Anche la scelta se la madre lavori o resti a casa nei primi anni di vita del bambino dipende
dalla cultura di appartenenza, e influisce sulla personalità del bambino stesso.</p>
...
di non essere perfetti: questo processo, se ben dosato, contribuisce a uno sviluppo psichico sano.</p>
<p>Sia il rispecchiamento sia l'idealizzazione dei genitori devono quindi essere, da un lato, incoraggiati dai genitori e, dall'altro,
frustrati in modo ottimale. Se questo avviene, il Sé nucleare, il Sé grandioso e il Sé idealizzato (formato dall'immagine
genitoriale interiorizzata) si integrano nel <strong>Sé coeso</strong>, obiettivo dello sviluppo, caratterizzato da un buon grado
di integrazione, coerenza e vitalità. Questo passaggio avviene grazie al processo di <strong>internalizzazione
trasmutante</strong>: lo spostamento di alcuni aspetti del narcisismo primario dal Sé grandioso verso una struttura psichica nuova,
più realistica e indipendente. Lo sviluppo si conclude in un cosiddetto <strong>Sé autonomo</strong>.</p>
...
<p>Tutti questi disturbi sono accomunati dall'incapacità di costruire relazioni interpersonali reali, strette e caratterizzate da un
amore autentico.</p>
