...
<p>La scienza è un processo cumulativo: la domanda di ricerca si basa su teorie già formulate, e una <strong>teoria</strong> è un'asserzione, o un insieme di asserzioni, riguardanti le relazioni tra variabili. Una teoria scientifica deve poter essere messa alla prova con una predizione precisa, verificabile come vera o falsa: secondo il principio di falsificabilità proposto da Karl Popper, una teoria scientifica deve poter essere, in linea di principio, dimostrata falsa.</p>
...
<ul>
<li><strong>ricerca osservazionale</strong>: uno o più osservatori registrano variabili come età, genere e numero di spinte di ciascun bambino, senza cercare di influenzare il comportamento. Usare più osservatori permette di calcolare un indice di accordo, che garantisce maggiore oggettività;</li>
...
<p>L'assegnazione casuale dei partecipanti ai due gruppi può essere semplice o stratificata (per esempio per età e sesso), fatta manualmente o tramite software; quanto più il campione è ampio, tanto più si riducono le differenze individuali tra i due gruppi.</p>
...
<p>Agli inizi degli anni '40 la società psicoanalitica britannica era divisa in tre gruppi teorici: il gruppo di Anna Freud e degli psicologi dell'Io, il gruppo di Melanie Klein e degli esponenti della teoria kleiniana, e, a metà tra i due, gli indipendenti della Scuola Inglese delle Relazioni Oggettuali. È in questo terzo gruppo che si colloca John Bowlby.</p>

<h3>Lo strano caso della teoria dell'attaccamento</h3>
<p>Bowlby ha proposto una teoria del funzionamento psichico basata sulla motivazione primaria di stabilire un legame profondo, di attaccamento, con la madre. Nonostante Bowlby abbia sempre riconosciuto l'influenza del pensiero psicoanalitico sulla propria teoria (in particolare di Fairbairn e della Scuola Inglese delle Relazioni Oggettuali), la sua teoria dell'attaccamento è stata accolta con molte critiche e poco entusiasmo dalla società psicoanalitica britannica. Peter Fonagy ha osservato che l'opposizione alla teoria di Bowlby fu uno dei pochi punti di accordo tra Anna Freud e Melanie Klein, spesso in forte contrasto tra loro: entrambe ritenevano che la teoria di Bowlby non potesse essere considerata psicoanalitica. Va comunque sottolineato che nessun altro autore psicoanalitico ha avuto un'influenza pari a quella di Bowlby nel mettere in relazione la psicoanalisi con altre discipline, come la psicologia empirica e la biologia: secondo alcuni autori, è stata proprio la teoria dell'attaccamento a garantire, in buona parte, la sopravvivenza della psicoanalisi in ambito accademico.</p>

<h3>Le due critiche principali alla teoria dell'attaccamento</h3>
<p>La comunità psicoanalitica dell'epoca muoveva a Bowlby due critiche fondamentali:</p>
<ol>
<li>adottando una prospettiva evolutiva, la teoria dell'attaccamento non considera a sufficienza gli aspetti di vulnerabilità psicobiologica e di simbolizzazione che contraddistinguono il funzionamento psichico di ciascun bambino: secondo gli psicoanalisti dell'epoca, Bowlby dava troppo poco peso alle differenze individuali e costituzionali, mettendo invece in primo piano gli aspetti evolutivi comuni a tutti gli esseri umani e l'importanza del primo ambiente e delle prime relazioni socio-emotive;</li>
<li>adottando una prospettiva empirica basata su definizioni operazionali, la teoria dell'attaccamento semplificherebbe in modo eccessivo la complessità del funzionamento psichico (il testo su cui si basano questi appunti si interrompe qui: il seguito di questa seconda critica sarà probabilmente ripreso nella lezione successiva).</li>
</ol>
