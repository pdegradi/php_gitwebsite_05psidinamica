...
ansiosi, ossessivo-compulsivi (ossessivi vs compulsivi), isterici/istrionici (inibiti vs espansivi), dissociativi, e una categoria
mista/altro.</p>
...
<p>L'Asse S riprende la nosografia dell'Asse I del DSM, riformulando i disturbi in modo descrittivo per cogliere l'esperienza
soggettiva associata ai sintomi (in termini di stati affettivi, pattern cognitivi, stati somatici e pattern relazionali), invece di
limitarsi a un elenco di criteri diagnostici.</p>
...
<p>Per evitare l'<strong>etichettamento precoce</strong> (data la continua evoluzione della personalità infantile), non si parla di
disturbi ma di categorie più vaghe e con terminologia diversa da quella degli adulti: timorosi della vicinanza (schizoide),
sospettosi/diffidenti, antisociali, narcisistici, impulsivi/esplosivi, autopunitivi, depressivi, somatizzanti, dipendenti,
evitanti/coartati (con variante controfobica, per chi mostra un livello di paura anormalmente basso, cercando rischi e attività
estreme), ansiosi, ossessivo-compulsivi, istrionici, su base disregolatoria, e misti.</p>
...
<p>I sistemi diagnostici più usati, come il DSM, non tengono conto dell'organizzazione dei circuiti neuronali sottostanti ai
comportamenti. Questo è un limite sia nella <strong>pratica clinica</strong> (la comorbilità è la regola, non l'eccezione, proprio
perché i circuiti emotivi e cognitivi sono fortemente interconnessi) sia nella <strong>ricerca</strong> (è difficile isolare gruppi
di pazienti con una sola diagnosi pura, il che mette in discussione la validità degli studi basati su categorie diagnostiche).</p>
...
<p>Nel 2009 il <strong>National Institute of Mental Health</strong> (NIMH) statunitense ha lanciato il progetto <strong>"Research
Domain Criteria"</strong> (RDoC), un progetto di ricerca (non di pratica clinica) volto a sviluppare una nuova classificazione
<strong>dimensionale</strong> dei disturbi mentali, basata su comportamenti osservabili e indici neurobiologici, indipendente dalle
categorie nosografiche tradizionali.</p>
...
<p>Il primo obiettivo della ricerca in psicoterapia è valutare se la psicoterapia, nel suo insieme, funziona: permette di ottenere
cambiamenti? La sua efficacia è maggiore di altri metodi, per esempio gli psicofarmaci? Quale approccio funziona meglio —
comportamentale, psicodinamico, cognitivo? Cosa succede in una psicoterapia che determina il cambiamento, e cosa fanno paziente e
terapeuta per raggiungerlo?</p>
