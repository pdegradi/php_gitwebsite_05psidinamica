...
<p>Come già per Mitchell e per Sullivan, anche per la teoria intersoggettiva le prime relazioni con le figure significative sono
determinanti nella formazione della personalità, ma è l'insieme delle relazioni vissute in tutto l'arco della vita a definirla: la
personalità è quindi in continua evoluzione e riformulazione.</p>
...
<p>Per Freud la funzione principale della mente era la scarica dell'eccitamento: ogni esperienza produce un innalzamento di tensione
affettiva che, attraverso la scarica, si risolve riportando la mente ai livelli di base. Per la psicoanalisi contemporanea, invece,
...
esattamente come era stato conservato. Questa idea di inconscio come un serbatoio di contenuti già del tutto formati è stata
rifiutata dalla gran parte della psicoanalisi contemporanea e criticata anche dalla psicologia cognitiva.</p>



<h3>Donnel Stern e l'esperienza non formulata</h3>
<p>Una proposta alternativa è quella di Donnel Stern, psicoanalista relazionale contemporaneo (i suoi lavori principali su questo tema
sono tra il 1989 e il 1997; da non confondere con Daniel N. Stern, lo studioso dello sviluppo infantile citato più avanti). Per
Donnel Stern, l'inconscio può essere definito come <strong>esperienza non formulata</strong>, cioè l'esperienza grezza e non ancora
tradotta in parole, che precede la sua rappresentazione. Un contenuto psichico è quindi inconscio semplicemente perché non è stato
ancora articolato, e per portarlo alla coscienza occorre formularlo, in primo luogo attraverso il linguaggio.</p>
...
averle già attribuito un significato definito? Per spiegarlo si può richiamare la teoria del conflitto di Freud, applicata qui in
modo diverso:</p>
<ol>
...
<p>Un'altra proposta contemporanea, che riprende comunque il modello freudiano, è quella di George Klein, formatosi nella tradizione
della Psicologia dell'Io. Per Klein uno degli aspetti più rilevanti della rimozione è impedire <strong>l'associazione
...
<p>Un esempio: un amico riceve una proposta di lavoro interessante, a cui deve rispondere in pochi giorni. Il giorno seguente si
sveglia con una sensazione di vuoto allo stomaco, che sa descrivere con precisione, ma senza collegarla alla proposta di lavoro. In
questo caso l'esperienza fisica è del tutto cosciente, ma il suo significato (il legame con lo stress per la decisione da prendere)
