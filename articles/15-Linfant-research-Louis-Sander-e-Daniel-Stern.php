...
<img XXclass="zoomable" src="/assets/images/Louis-Sander.webp" />
<p>Louis Sander è considerato il padre dell'Infant Research. Introduce la <strong>prospettiva sistemica</strong>: l'idea che ogni
individuo, fin dalla nascita, sia un sistema vivente che si sviluppa attraverso l'interazione di due processi:</p>
<ul>
<li>l'<strong>attività primaria</strong>: la motivazione innata del bambino ad agire per adattarsi all'ambiente e integrarsi con
esso (simile alla motivazione descritta dalla teoria dell'attaccamento);</li>
...
<li><strong>18-36 mesi, "riconoscimento" e "inversione"</strong>: 
<ul>
    <li>il <strong>riconoscimento</strong> è la capacità del bambino di comunicare a parole i propri stati interni, che la madre può validare o meno</li>
    <li>l'<strong>inversione</strong> riguarda i comportamenti con cui il bambino rompe intenzionalmente l'armonia dell'interazione — 
il modo in cui la madre reagisce a questi episodi contribuisce a definirne la personalità.</li></li>
</ul>
</ul>


<h3>La teoria epigenetica dello sviluppo</h3>
<p>La teoria di Sander è chiamata anche <strong>teoria epigenetica dello sviluppo</strong>. L'<strong>epigenetica</strong> studia
come l'ambiente modifica l'espressione della genetica di un organismo. Per molto tempo si è pensato che la direzione fosse una
sola: dalla biologia alla personalità. Sander, insieme alle teorie più moderne, sostiene invece che biologia e ambiente si
influenzano a vicenda (<strong>bidirezionalità</strong>).</p>
...
modalità sensoriale e tradurla in un'altra.</p>
